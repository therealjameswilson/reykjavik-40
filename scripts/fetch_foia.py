...
NETWORK_KEYWORDS = {
    ...
    "Poindexter": ("us.poindexter", "John M. Poindexter", "US", "National Security Advisor"),
    ...
    "Karpov": ("ussr.karpov", "Viktor M. Karpov", "USSR", "Head, Soviet Delegation to the Nuclear and Space Talks"),
}
